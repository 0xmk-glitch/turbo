  ...
  taskTypeOptions: DropdownOption[] = [
    {
      ...
      label: 'Work',
      icon: 'work',
      iconClass: 'text-sm text-accent-600',
    },
    {
      value: 'personal',
      label: 'Personal',
      icon: 'person',
      iconClass: 'text-sm text-green-600',
    },
    {
      value: 'home',
      label: 'Home',
      icon: 'home',
      iconClass: 'text-sm text-purple-600',
    },
  ];
  ...
  priorityOptions: DropdownOption[] = [
    {
      ...
      label: 'Low',
      icon: 'circle',
      iconClass: 'w-3 h-3 bg-green-500 rounded-full',
    },
    {
      value: 2,
      label: 'Medium',
      icon: 'circle',
      iconClass: 'w-3 h-3 bg-yellow-500 rounded-full',
    },
    {
      value: 3,
      label: 'High',
      icon: 'circle',
      iconClass: 'w-3 h-3 bg-orange-500 rounded-full',
    },
    {
      value: 4,
      label: 'Urgent',
      icon: 'circle',
      iconClass: 'w-3 h-3 bg-red-500 rounded-full',
    },
  ];
