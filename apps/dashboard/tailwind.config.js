  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'soft-xl':
          '0 8px 10px -2px rgba(0, 0, 0, 0.06), 0 4px 6px -2px rgba(0, 0, 0, 0.02)',
        'elevation-1':
          '0 1px 2px rgba(0, 0, 0, 0.08), 0 1px 1px rgba(0, 0, 0, 0.12)',
        'elevation-2':
          '0 2px 4px rgba(0, 0, 0, 0.08), 0 1px 2px rgba(0, 0, 0, 0.12)',
        'elevation-3':
          '0 4px 8px rgba(0, 0, 0, 0.08), 0 2px 4px rgba(0, 0, 0, 0.12)',
      },
      borderRadius: {
        xl: '0.75rem',
        '2xl': '1rem',
