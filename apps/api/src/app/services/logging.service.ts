  ...
  private loadConfig(): LoggingConfig {
    ...
    return {
      enableLogging: this.configService.get<boolean>(
        'LOGGING_ENABLED',
        defaultLoggingConfig.enableLogging,
      ),
      logLevel,
      enableAuditLogging: this.configService.get<boolean>(
        'AUDIT_LOGGING_ENABLED',
        defaultLoggingConfig.enableAuditLogging,
      ),
      enableRequestLogging: this.configService.get<boolean>(
        'REQUEST_LOGGING_ENABLED',
        defaultLoggingConfig.enableRequestLogging,
      ),
      enableResponseLogging: this.configService.get<boolean>(
        'RESPONSE_LOGGING_ENABLED',
        defaultLoggingConfig.enableResponseLogging,
      ),
      enablePerformanceLogging: this.configService.get<boolean>(
        'PERFORMANCE_LOGGING_ENABLED',
        defaultLoggingConfig.enablePerformanceLogging,
      ),
      redactSensitiveFields: this.configService
        .get<string>(
      ...
      logFormat: this.configService.get<'json' | 'pretty'>(
        'LOG_FORMAT',
        defaultLoggingConfig.logFormat,
      ),
      auditLogFile: this.configService.get<string>(
        'AUDIT_LOG_FILE',
        defaultLoggingConfig.auditLogFile,
      ),
      requestLogFile: this.configService.get<string>(
        'REQUEST_LOG_FILE',
        defaultLoggingConfig.requestLogFile,
      ),
    };
  }
